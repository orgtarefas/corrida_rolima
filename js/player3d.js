// ==================== GERENCIAMENTO DO JOGADOR (3D) ====================

let currentPlayer = null;

const playerCar = {
    x: 400, y: 0, width: 32, height: 42,
...
function updateGarageUI3D() {
    ...
    updateUpgradeButtons3D();
}

function updateUpgradeButtons3D() {
    if (!currentPlayer) return;
